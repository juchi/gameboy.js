...
var ops = {
    ...
    BITirra:function(p, i, r1, r2) {var addr = ops._getRegAddr(p, r1, r2);var mask=1<<i;var z=(p.memory[addr]&mask)?0:1;var f=p.r.F&0x10;f |= 0x20;if(z)f|=0x80;p.r.F=f;p.clock.c+=12;},
