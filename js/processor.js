...
var map = {
    ...
    0x07: function(p){var out=p.r.A & 0x80?1:0; out ? p.r.F=0x10:p.r.F=0; p.r.A=((p.r.A<<1)+out)&0xFF;p.clock.c+=4;},
    ...
    0x0F: function(p){var out=p.r.A & 0x01; out ? p.r.F=0x10:p.r.F=0; p.r.A=(p.r.A>>1)|(out*0x80);p.clock.c+=4;},
    ...
    0x17: function(p){var c = (p.r.F&0x10)?1:0;var out=p.r.A & 0x80?1:0; out ? p.r.F=0x10:p.r.F=0; p.r.A=((p.r.A<<1)+c)&0xFF;p.clock.c+=4;},
    ...
    0x1F: function(p){var c = (p.r.F&0x10)?1:0;var out=p.r.A & 0x01; out ? p.r.F=0x10:p.r.F=0; p.r.A=(p.r.A>>1)|(c*0x80);p.clock.c+=4;},
...
var cbmap = {
    ...
    0x80: function(p){ops.SETir(p, 0, 'B');},
    0x81: function(p){ops.SETir(p, 0, 'C');},
    0x82: function(p){ops.SETir(p, 0, 'D');},
    0x83: function(p){ops.SETir(p, 0, 'E');},
    0x84: function(p){ops.SETir(p, 0, 'H');},
    0x85: function(p){ops.SETir(p, 0, 'L');},
    //0x86: function(p){ops.SETir(p, 0, 'B');},
    0x87: function(p){ops.SETir(p, 0, 'A');},
    0x88: function(p){ops.SETir(p, 1, 'B');},
    0x89: function(p){ops.SETir(p, 1, 'C');},
    0x8A: function(p){ops.SETir(p, 1, 'D');},
    0x8B: function(p){ops.SETir(p, 1, 'E');},
    0x8C: function(p){ops.SETir(p, 1, 'H');},
    0x8D: function(p){ops.SETir(p, 1, 'L');},
    //0x8E: function(p){ops.SETir(p, 1, 'B');},
    0x8F: function(p){ops.SETir(p, 1, 'A');},

    0x90: function(p){ops.SETir(p, 2, 'B');},
    0x91: function(p){ops.SETir(p, 2, 'C');},
    0x92: function(p){ops.SETir(p, 2, 'D');},
    0x93: function(p){ops.SETir(p, 2, 'E');},
    0x94: function(p){ops.SETir(p, 2, 'H');},
    0x95: function(p){ops.SETir(p, 2, 'L');},
    //0x96: function(p){ops.SETir(p, 2, 'B');},
    0x97: function(p){ops.SETir(p, 2, 'A');},
    0x98: function(p){ops.SETir(p, 3, 'B');},
    0x99: function(p){ops.SETir(p, 3, 'C');},
    0x9A: function(p){ops.SETir(p, 3, 'D');},
    0x9B: function(p){ops.SETir(p, 3, 'E');},
    0x9C: function(p){ops.SETir(p, 3, 'H');},
    0x9D: function(p){ops.SETir(p, 3, 'L');},
    //0x9E: function(p){ops.SETir(p, 3, 'B');},
    0x9F: function(p){ops.SETir(p, 3, 'A');},

    0xA0: function(p){ops.SETir(p, 4, 'B');},
    0xA1: function(p){ops.SETir(p, 4, 'C');},
    0xA2: function(p){ops.SETir(p, 4, 'D');},
    0xA3: function(p){ops.SETir(p, 4, 'E');},
    0xA4: function(p){ops.SETir(p, 4, 'H');},
    0xA5: function(p){ops.SETir(p, 4, 'L');},
    //0xA6: function(p){ops.SETir(p, 4, 'B');},
    0xA7: function(p){ops.SETir(p, 4, 'A');},
    0xA8: function(p){ops.SETir(p, 5, 'B');},
    0xA9: function(p){ops.SETir(p, 5, 'C');},
    0xAA: function(p){ops.SETir(p, 5, 'D');},
    0xAB: function(p){ops.SETir(p, 5, 'E');},
    0xAC: function(p){ops.SETir(p, 5, 'H');},
    0xAD: function(p){ops.SETir(p, 5, 'L');},
    //0xAE: function(p){ops.SETir(p, 5, 'B');},
    0xAF: function(p){ops.SETir(p, 5, 'A');},

    0xB0: function(p){ops.SETir(p, 6, 'B');},
    0xB1: function(p){ops.SETir(p, 6, 'C');},
    0xB2: function(p){ops.SETir(p, 6, 'D');},
    0xB3: function(p){ops.SETir(p, 6, 'E');},
    0xB4: function(p){ops.SETir(p, 6, 'H');},
    0xB5: function(p){ops.SETir(p, 6, 'L');},
    //0xB6: function(p){ops.SETir(p, 6, 'B');},
    0xB7: function(p){ops.SETir(p, 6, 'A');},
    0xB8: function(p){ops.SETir(p, 7, 'B');},
    0xB9: function(p){ops.SETir(p, 7, 'C');},
    0xBA: function(p){ops.SETir(p, 7, 'D');},
    0xBB: function(p){ops.SETir(p, 7, 'E');},
    0xBC: function(p){ops.SETir(p, 7, 'H');},
    0xBD: function(p){ops.SETir(p, 7, 'L');},
    //0xBE: function(p){ops.SETir(p, 7, 'B');},
    0xBF: function(p){ops.SETir(p, 7, 'A');},

    0xC0: function(p) {ops.SETir(0, 'B');},
    0xC1: function(p) {ops.SETir(0, 'C');},
    0xC2: function(p) {ops.SETir(0, 'D');},
    0xC3: function(p) {ops.SETir(0, 'E');},
    0xC4: function(p) {ops.SETir(0, 'H');},
    0xC5: function(p) {ops.SETir(0, 'L');},
    //0xC6: function(p) {ops.SETirra(0, 'H', 'L');},
    0xC7: function(p) {ops.SETir(0, 'A');},
    0xC8: function(p) {ops.SETir(1, 'B');},
    0xC9: function(p) {ops.SETir(1, 'C');},
    0xCA: function(p) {ops.SETir(1, 'D');},
    0xCB: function(p) {ops.SETir(1, 'E');},
    0xCC: function(p) {ops.SETir(1, 'H');},
    0xCD: function(p) {ops.SETir(1, 'L');},
    //0xCE: function(p) {ops.SETirra(1, 'H', 'L');},
    0xCF: function(p) {ops.SETir(1, 'A');},

    0xD0: function(p) {ops.SETir(2, 'B');},
    0xD1: function(p) {ops.SETir(2, 'C');},
    0xD2: function(p) {ops.SETir(2, 'D');},
    0xD3: function(p) {ops.SETir(2, 'E');},
    0xD4: function(p) {ops.SETir(2, 'H');},
    0xD5: function(p) {ops.SETir(2, 'L');},
    //0xD6: function(p) {ops.SETirra(2, 'H', 'L');},
    0xD7: function(p) {ops.SETir(2, 'A');},
    0xD8: function(p) {ops.SETir(3, 'B');},
    0xD9: function(p) {ops.SETir(3, 'C');},
    0xDA: function(p) {ops.SETir(3, 'D');},
    0xDB: function(p) {ops.SETir(3, 'E');},
    0xDC: function(p) {ops.SETir(3, 'H');},
    0xDD: function(p) {ops.SETir(3, 'L');},
    //0xDE: function(p) {ops.SETirra(3, 'H', 'L');},
    0xDF: function(p) {ops.SETir(3, 'A');},

    0xE0: function(p) {ops.SETir(4, 'B');},
    0xE1: function(p) {ops.SETir(4, 'C');},
    0xE2: function(p) {ops.SETir(4, 'D');},
    0xE3: function(p) {ops.SETir(4, 'E');},
    0xE4: function(p) {ops.SETir(4, 'H');},
    0xE5: function(p) {ops.SETir(4, 'L');},
    //0xE6: function(p) {ops.SETirra(4, 'H', 'L');},
    0xE7: function(p) {ops.SETir(4, 'A');},
    0xE8: function(p) {ops.SETir(5, 'B');},
    0xE9: function(p) {ops.SETir(5, 'C');},
    0xEA: function(p) {ops.SETir(5, 'D');},
    0xEB: function(p) {ops.SETir(5, 'E');},
    0xEC: function(p) {ops.SETir(5, 'H');},
    0xED: function(p) {ops.SETir(5, 'L');},
    //0xEE: function(p) {ops.SETirra(5, 'H', 'L');},
    0xEF: function(p) {ops.SETir(5, 'A');},

    0xF0: function(p) {ops.SETir(6, 'B');},
    0xF1: function(p) {ops.SETir(6, 'C');},
    0xF2: function(p) {ops.SETir(6, 'D');},
    0xF3: function(p) {ops.SETir(6, 'E');},
    0xF4: function(p) {ops.SETir(6, 'H');},
    0xF5: function(p) {ops.SETir(6, 'L');},
    //0xF6: function(p) {ops.SETirra(6, 'H', 'L');},
    0xF7: function(p) {ops.SETir(6, 'A');},
    0xF8: function(p) {ops.SETir(7, 'B');},
    0xF9: function(p) {ops.SETir(7, 'C');},
    0xFA: function(p) {ops.SETir(7, 'D');},
    0xFB: function(p) {ops.SETir(7, 'E');},
    0xFC: function(p) {ops.SETir(7, 'H');},
    0xFD: function(p) {ops.SETir(7, 'L');},
    //0xFE: function(p) {ops.SETirra(7, 'H', 'L');},
    0xFF: function(p) {ops.SETir(7, 'A');}
};
