...
var cbmap = {
    ...
    //0x86: function(p){ops.RESir(p, 0, 'B');},
    ...
    //0x8E: function(p){ops.RESir(p, 1, 'B');},
    ...
    //0x96: function(p){ops.RESir(p, 2, 'B');},
    ...
    //0x9E: function(p){ops.RESir(p, 3, 'B');},
    ...
    //0xA6: function(p){ops.RESir(p, 4, 'B');},
    ...
    //0xAE: function(p){ops.RESir(p, 5, 'B');},
    ...
    //0xB6: function(p){ops.RESir(p, 6, 'B');},
    ...
    //0xBE: function(p){ops.RESir(p, 7, 'B');},
...
var ops = {
    ...
    SLArra: function(p, r1, r2) {var addr = ops._getRegAddr(p, r1, r2);p.r.F = 0;if (p.memory[addr]&0x80)p.r.F|=0x10;p.memory[addr]=(p.memory[addr]<<1)&0xFF;if (p.memory[addr]==0)p.r.F|=0x80;p.clock.c+=4;},
